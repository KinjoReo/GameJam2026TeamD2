...
//更新処理
void Projecttile::Update(float delta_second)
{
...
// 当たり判定通知処理
void Projecttile::OnHitCollision(GameObject* hit_object)
{

}

/// 攻撃範囲通知処理
void Projecttile::OnAreaDetection(GameObject* hit_object)
{
...
// 移動処理
void Projecttile::Movement(float delta_second)
{
...
// アニメーション制御処理
void Projecttile::AnimationControl(float delta_second)
{

}
// エフェクト制御処理
void Projecttile::EffectControl(float delta_second)
{

}

// ターゲット設定処理
void Projecttile::SetTargetLocation(Vector2D location)
{
	target_location = location;
}

// ダメージ設定処理
void Projecttile::SetDamage(float Damage)
{
	this->Damage = Damage;
}